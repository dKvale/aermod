...
```{r}
library(tidyverse)
library(installEPA) #remotes::install_github(c("dKvale/installEPA"))
...
aer_inp <- mutate(aer_inp,
                  adjust_ustar = ifelse(u_star, "Y", "N")) 
